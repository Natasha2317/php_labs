...
<html>
	<head>
    <title>Воронина Анастасия Александровна, 181-321. Лабораторная № 7 «Основы использования массивов в программировании. Ввод данных и сортировка массивов»</title>
			...
			<div class="header-wrapper">
				<div>
					<div>
                        ...
                        <?php
                            if (empty($_POST['element0'])) //Если массив не задан
                            {
                                echo '<div class="alert alert-danger mt-3 mb-4" role="alert">
                                    Массив не был задан
                                </div>';
				...
				<div class="row">
					<div class="col-sm 12 col-md-12 col-lg-12 col-xl-12">
						<div class="scrollyeah" data-shadows="false">
							<div>
								<p class="small">Направление «Информатика и вычислительная техника», программа обучения «Веб-технологии». 1 курс, 2 семестр</p>
							</div>
					</div>
				</div>
			</div>
